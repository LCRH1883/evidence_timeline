...
- [ ] **CHANGELOG.md**: Add version link at the bottom (e.g., `[1.1.1]: https://github.com/LCRH1883/evidence_timeline/releases/tag/v1.1.1`)
- [ ] **evidence_timeline.csproj**: Update `Version`, `AssemblyVersion`, and `FileVersion` (e.g., `1.1.1` and `1.1.1.0`)
- [ ] **installer.iss**: Update `MyAppVersion` define (e.g., `#define MyAppVersion "1.1.1"`)
- [ ] **update.xml**: Update `<version>` tag (e.g., `1.1.1`)
- [ ] **update.xml**: Update `<url>` tag with new download URL (e.g., `https://github.com/LCRH1883/evidence_timeline/releases/download/v1.1.1/EvidenceTimeline-Setup-v1.1.1.exe`)
- [ ] **update.xml**: Update `<changelog>` tag with new release URL (e.g., `https://github.com/LCRH1883/evidence_timeline/releases/tag/v1.1.1`)
...
- [ ] Tag release: `git tag v{version}` (e.g., `git tag v1.1.1`)
...
- [ ] Release title: `Evidence Timeline v{version}` (e.g., `Evidence Timeline v1.1.1`)
...
### Important Notes
- **Installer naming scheme:** `EvidenceTimeline-Setup-v{version}.exe` (e.g., `EvidenceTimeline-Setup-v1.1.1.exe`)
- **Installer output location:** `D:\Projects\evidence_timeline\installer_output\`
- **Version format:** Use semantic versioning `MAJOR.MINOR.PATCH` (e.g., `1.1.1`)
- **Git tag format:** Always prefix with `v` (e.g., `v1.1.1`)
